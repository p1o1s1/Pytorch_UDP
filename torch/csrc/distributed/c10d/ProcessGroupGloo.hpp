...
class TORCH_API ProcessGroupGloo : public ProcessGroup {
 public:
  ...
  static std::shared_ptr<::gloo::transport::Device> createDeviceForInterface(
      const std::string& interface, const std::string& transportName);

  // Create new device instance for specific hostname or address.
  static std::shared_ptr<::gloo::transport::Device> createDeviceForHostname(
      const std::string& hostname, const std::string& transportName);
  ...
  static std::shared_ptr<::gloo::transport::Device> createDefaultDevice(const std::string& transportName);
